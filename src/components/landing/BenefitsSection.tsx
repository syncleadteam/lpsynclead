...
const benefits = [
  {
    ...
    desc: "Diminua a necessidade de uma grande equipe de suporte. Sua IA cobre o volume sem aumentar a folha.",
    metric: "-70%",
  ...
  },
  {
    ...
    desc: "Todo contato é respondido em menos de 1 minuto, em qualquer horário e em qualquer canal.",
    metric: "<1min",
  ...
  },
  {
    ...
    desc: "Atenda 1.000 pessoas com a mesma qualidade de quem atende 10. Cresça sem reestruturar a operação.",
    metric: "100x",

    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground max-w-lg">
          Compartilhe informações adicionais sobre seu projeto, integrações existentes,
          volume de atendimento ou qualquer detalhe que ajude na implantação.
        </p>
      </div>
      <div>
        ...
        <textarea
          ...
          rows={6}
          maxLength={2000}
          placeholder="Ex: Temos cerca de 500 atendimentos/dia, usamos CRM XYZ, precisamos integrar com o sistema de agendamento..."

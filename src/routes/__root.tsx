  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Algo deu errado por aqui. Você pode tentar atualizar a página ou voltar ao início.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sync Lead — Automação de Atendimento com IA no WhatsApp" },
      {
        ...
        content:
          "Agentes de IA que vendem, agendam e oferecem suporte no WhatsApp, 24 horas por dia, 7 dias por semana.",
      },
